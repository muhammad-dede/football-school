...
const breadcrumbs = [
    ...
    { title: "Pembayaran Tagihan", href: "/billing/payment/create" },
];
...
const submit = () => {
    form.post(route("billing.payment.store", props.billing?.id), {
        forceFormData: true,
        preserveScroll: true,
    });
};
        ...
        <MainContent>
            <HeadingGroup>
                <Heading
                    ...
                    description="Formulir untuk pembayaran tagihan"
                />
            </HeadingGroup>
